...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        var input = "stack —“≈œ≈Õ‹(3,—“≈œ≈Õ‹(5,2))asd asd +asd a=do\r\nasda —“≈œ≈Õ‹(3,2+asda) asda\r\nasdassd —“≈œ≈Õ‹(3,—“≈œ≈Õ‹(5,2))aaaa ()asldklak\r\n—“≈œ≈Õ‹(3,—“≈œ≈Õ‹(—“≈œ≈Õ‹((1+1),2),2)) +++ ()asd ()";
        //var input = "—“≈œ≈Õ‹(3,2)";
    ...
    {
        public const string SEQ_OPEN = "—“≈œ≈Õ‹(";
        public const string SEQ_CLOSE = ")";
        public const char SKIP_OPEN = '(';
        public const char SKIP_CLOSE = ')';
        public static readonly Regex regex = new Regex(@"—“≈œ≈Õ‹\(", RegexOptions.Singleline);
    ...
    {
        public const string FUNC_NAME_MATH_POW = "—“≈œ≈Õ‹";
        ...
        public string ReplaceMathPow(string input)
        {
            ...
            // ÔÓ ÛÏÓÎ˜‡ÌË˛ mathces ÓÚÒÚÓÚËÓ‚‡Ì ÔÓ ËÌ‰ÂÍÒÛ ‚ Ì‡Ô‡‚ÎÂÌËË ÔÓËÒÍ‡ ÚÂÍÒÚÂ (ÒÎÂ‚‡ Ì‡Ô‡‚Ó)
